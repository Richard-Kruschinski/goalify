...
import '../../data/repositories/interval_timer_repository_impl.dart';
...
class IntervalTimerController extends ChangeNotifier {
  ...
  final IntervalTimerRepository _repo = IntervalTimerRepositoryImpl();
  ...
  Future<void> _loadProfiles() async {
    _customProfiles = await _repo.loadProfiles();

    final selectedId = await _repo.loadSelectedProfileId();
    if (selectedId != null) {
  ...
  Future<void> _saveProfiles() async {
    await _repo.saveProfiles(_customProfiles);
  }

  Future<void> _saveSelectedProfile() async {
    await _repo.saveSelectedProfileId(_selectedProfileId);
  }
